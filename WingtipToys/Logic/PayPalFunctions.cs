...
public class NVPAPICaller
{
    ...
    public string APIUsername = "marckopolo4real-facilitator_api1.gmail.com";
    private string APIPassword = "AL3QJ7ADX4N7K3E8";
    private string APISignature = "AkJ2qyGtsqiaHpJiH7XKO404aVSvAHPZKal5PWqbrv1KZKcSwzFE5HJh";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:58643/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:58643/Checkout/CheckoutCancel.aspx";
